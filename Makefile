...
pkgdatadir = $(datadir)/e2pdiag
pkgincludedir = $(includedir)/e2pdiag
pkglibdir = $(libdir)/e2pdiag
pkglibexecdir = $(libexecdir)/e2pdiag
...
OBJEXT = o
PACKAGE = e2pdiag
PACKAGE_BUGREPORT = javad321javad@gmail.com
PACKAGE_NAME = e2pdiag
PACKAGE_STRING = e2pdiag 1.0
PACKAGE_TARNAME = e2pdiag
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
SUBDIRS = src test src/app_layer/eeprom
all: config.h
